...
class DatosAmbientalesFragment : Fragment(R.layout.fragment_datos_ambientales) {
    ...
    private fun validarCamposFormulario(): Boolean {
        ...
        } else { binding.idErrorAcuNatu.visibility = View.GONE }
        ...
        } else { binding.idErrorAcuArtifi.visibility = View.GONE }
        ...
        } else { binding.idErrorTerresNatu.visibility = View.GONE }
        ...
        } else { binding.idErrorTrataBasura.visibility = View.GONE }
        ...
        } else { binding.idErrorSeparaBasu.visibility = View.GONE }
        ...
        } else { binding.idErrorCoverSuelos.visibility = View.GONE }
        ...
        } else { binding.idErrorAreasErocion.visibility = View.GONE }
        ...
        } else { binding.idErrorEvidenciaRemocion.visibility = View.GONE }
        ...
        } else { binding.idErrorCapturaAnimales.visibility = View.GONE }
        ...
        } else { binding.idErrorCapturaAguaLluvia.visibility = View.GONE }
